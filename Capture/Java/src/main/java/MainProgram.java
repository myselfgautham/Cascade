...
import ImageCapture.ImageFrame;
...
public class MainProgram {
    private static final Integer MAX_IMAGE_W = 640;
    private static final Integer MAX_IMAGE_H = 480;
    ...
    private final JLabel saveCountLabel = new JLabel();
    ...
    public MainProgram(JFrame frame) {
        windowFrame = frame;
    ...
    private void drawImage(ImageFrame frame, Integer lineIndex) {
        ...
        new Thread(() -> {
            synchronized (imageContainer) {
                ...
                if ((lineIndex != null) && ((selectedFolder != null) && (lineIndex == frame.getLineCount() - 1))) {
    ...
    public static void main(String[] args) {
        ...
        MainProgram window = new MainProgram(frame);
